...
Example: --memory shows allocated objects during every step of execution
    ...
    == execution ==
            stack: [ <script> ]
            heap : [ <String "c"> ][ <String "b"> ][ <String "a"> ][ <script> ][ <native fn> ][ <String "clock"> ]
    ...
    0004    | OP_ADD
            stack: [ <script> ][ "ab" ]
            heap : [ <String "ab"> ][ <String "c"> ][ <String "b"> ][ <String "a"> ][ <script> ][ <native fn> ][ <String "clock"> ]
    0005    | OP_CONSTANT           2   # "c"
            stack: [ <script> ][ "ab" ][ "c" ]
            heap : [ <String "ab"> ][ <String "c"> ][ <String "b"> ][ <String "a"> ][ <script> ][ <native fn> ][ <String "clock"> ]
    0007    | OP_ADD
            stack: [ <script> ][ "abc" ]
            heap : [ <String "abc"> ][ <String "ab"> ][ <String "c"> ][ <String "b"> ][ <String "a"> ][ <script> ][ <native fn> ][ <String "clock"> ]
    0008    | OP_PRINT
